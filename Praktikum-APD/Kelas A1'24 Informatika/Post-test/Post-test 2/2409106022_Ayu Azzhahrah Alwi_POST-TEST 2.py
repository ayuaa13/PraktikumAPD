...
print(f"Umur Saya Tahun ini {Umur} Tahun, Tinggi badan saya {Tinggi_Badan} M dan Jarak dari Rumah atau kos Saya ke Kampus {Jarak_Kampus} KM")
print(f"cita-cita saya adalah",Cita_cita[1])
